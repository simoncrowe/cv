...
\section{SKILLS} {\sl Languages:} Python, Bash, Javascript, SQL \\
                {\sl Technologies:} PostgreSQL, Redis, AWS, Terraform, Docker, Kafka, Kubernetes, OAuth2, Django, pytest \\
...
\section{EXPERIENCE} \textbf{Medtronic Digital Surgery} \\
                {\sl Senior Software Engineer} \hfill   Feb 2022 - present \\
                 \begin{itemize}  \itemsep  -0pt % reduce space between items
                   \item Wrote PoC video processing orchestrator with GPU support, enabling the same video \\
                         workload to be run at 6\% of the cost in under a fifth of the time.
                   \item Replaced overprivileged AWS IAM user credentials used in CI/CD pipelines \\
