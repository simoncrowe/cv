...
\section{SUMMARY} An engineer with extensive experience building and maintaining
                  ...
                  In my day-to-day work, I propagate conventions and best practices through code review,\\
                  refactoring and documentation.\
                  I'm comfortable working in platform teams and cross-functional product teams.
                  Practices I feel at home with include IaC, CI/CD and TDD.

\section{SKILLS} {\sl Languages:} Python, Bash, Javascript, SQL \\
                {\sl Technologies:} PostgreSQL, Redis, AWS, Terraform, Docker, Kafka, Kubernetes, OAuth2, FastAPI, Django, pytest \\
                {\sl Some exposure to:} Rust, Go, C\#, ffmpeg, Flask, SQLAlchemy, MongoDB, GCP


\section{EXPERIENCE} \textbf{Medtronic Digital Surgery} \\
                {\sl Senior Software Engineer} \hfill   Feb 2022 - present \\
                 \begin{itemize}  \itemsep  -0pt % reduce space between items
                   \item Implemented a video processing orchestrator using Kubernetes, FastAPI and Kafka,
                         that replaced AWS MediaConvert in 97\% of cases and and saved £300,000 annually.
                   \item Developed a fault-tolerant serverless solution for sending s3 objects to HTTP APIs –
                         Terraform module adopted by multiple teams to send events to the data platform.
                   \item Re-architected a legacy Git/LFS assets server for multi-region cloud deployments.
                   \item Replaced AWS IAM user credentials used in CI/CD with least-privilege roles.
