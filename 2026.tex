...
\usepackage{hyperref}
\usepackage{enumitem}
\setlist[itemize]{topsep=-5pt, partopsep=0pt, itemsep=2pt, parsep=0pt}
...
\section{EXPERIENCE} \textbf{Medtronic Digital Surgery} \\
                {\sl Senior Software Engineer} \hfill   Feb 2022 - present \\
                 \begin{itemize}
                   ...
                   \item Reconfigured VPCs allowing GPU workloads (ML inference and ffmpeg) to run across multiple
                         availability zones, removing a single-AZ availability bottleneck.
                   \item Developed a fault-tolerant serverless Terraform module for delivering S3 objects to HTTP APIs,
                         adopted by multiple teams to feed the data platform.
